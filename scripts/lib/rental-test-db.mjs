...
export async function createRentalTestDatabase({vehicles=false}={}) {
const db = new PGlite();
await db.exec(`
...
const required = readdirSync(dir).filter(file => file.endsWith('.sql') && (file.slice(0,14) <= '20260803213000' || file.startsWith('20260912180000') || file.startsWith('20260912193000') || file.startsWith('20260912210000') || (vehicles && (file.startsWith('20260813120000') || file.startsWith('20260827120000') || file.startsWith('2026091417'))))).sort();
